...
class DB:
    ...
    def add_user(self, email: str, hashed_password: str) -> User:
        ...
        Args:
            ...
            hashed_password (str): The hashed password of newuser.
    ...
    def find_user_by(self, **kwargs: Dict[str, str]) -> User:
        ...
        Raise:
            ...
            error: InvalidRequestError: When an invalid query
    ...
    def update_user(self, user_id: int, **kwargs) -> None:
        ...
        Args:
            ...
            **kwargs: Keyword arguments that represent the user attributes to
            update

        Raises:
            ValueError: If invalid attribute pass in kwargs
