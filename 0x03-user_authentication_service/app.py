...
def index() -> str:
    """GET /
    Return:
        - JSON payload containing welcome message.
    """
...
def users() -> str:
    """POST /users
    Return:
        - JSON payload of the form containing the information
    """
...
def login() -> str:
    """POST /sessions
    Return:
        - JSON payload of form containing login info.
    """
...
def profile() -> str:
    """GET /profile
    Return:
        - A JSON payload contains the email if successful.
    """
    # Get the session ID from the "session_id" cookie in the request
    session_id = request.cookies.get("session_id")
    # Retrieve the user associated with the session ID
