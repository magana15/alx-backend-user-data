...
class Auth:
    ...
    def create_session(self, email: str) -> str:
        """Creates a session and return the session ID as string.
    ...
    def get_user_from_session_id(self, session_id: str) -> Union[User, None]:
        ...
        Args:
            session_id (str): The ID of session to retrieve the user
    ...
    def destroy_session(self, user_id: int) -> None:
        ...
        Args:
            user_id (int): The ID of user whose session is to be destroyed.
    ...
    def get_reset_password_token(self, email: str) -> str:
        ...
        Args:
            email (str): A string representing the email address of
            the user to generate a password reset token for.

        Raises:
            ValueError: If no user with the specified
            email address is found.

        Returns:
            str: string representing password reset token generated
            for user
        """
        try:
            user = self._db.find_user_by(email=email)
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        ...
        Raises:
            ValueError: If the reset token invalid
